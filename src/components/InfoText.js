    ...
    render() {
        return (<Container className={"mt-3"}>
            <Row xs={1} md={2} className="g-4">
                <Col>
                    <Card style={coverWith(hyphaeImage)} className={"p-3 h-100"}>
                        <Row >
                            <Col>
                            </Col>
                ...
                <Col>
                    <Card style={coverWith(nematodeImage)} className={"p-3 h-100"}>
                        <Row>
                            <Col>
                            </Col>
                            <Col className={"bg-blur text-white rounded-2 "}>
                ...
                <Col>
                    <Card style={coverWith(teamImage)} className={"p-3 h-100"}>
                        <Row>
                            <Col>
                            </Col>
                            <Col className={"bg-blur text-white rounded-2 "}>
                ...
                <Col>
                    <Card style={coverWith(nematodeAreaImage)} className={"p-3 h-100"}>
                        <Row>
                            <Col>
                            </Col>
                            <Col className={"bg-blur text-white rounded-2 "}>
